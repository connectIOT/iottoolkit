...
if __name__ == '__main__' :
    ...
    outdoor_temperature.Observers.create({'resourceName': 'mqttObserver',\
                                        'resourceClass': 'mqttObserver'})
     
    outdoor_humidity = weather.create({'resourceName': 'outdoor_humidity',\
                                        'resourceClass': 'ObservableProperty'})
        
    outdoor_humidity.Observers.create({'resourceName': 'mqttObserver',\
                                        'resourceClass': 'mqttObserver'})
     
    sealevel_pressure = weather.create({'resourceName': 'sealevel_pressure',\
                                        'resourceClass': 'ObservableProperty'})
    
    sealevel_pressure.Observers.create({'resourceName': 'mqttObserver',\
                                        'resourceClass': 'mqttObserver'})
     
    indoor_temperature = weather.create({'resourceName': 'indoor_temperature',\
                                          'resourceClass': 'ObservableProperty'})

    indoor_temperature.Observers.create({'resourceName': 'mqttObserver',\
                                        'resourceClass': 'mqttObserver'})
     
    indoor_humidity = weather.create({'resourceName': 'indoor_humidity',\
                                        'resourceClass': 'ObservableProperty'})
    
    indoor_humidity.Observers.create({'resourceName': 'mqttObserver',\
                                      'resourceClass': 'mqttObserver'})
     
    wind_gust = weather.create({'resourceName': 'wind_gust',\
                                'resourceClass': 'ObservableProperty'})
    
    wind_gust.Observers.create({'resourceName': 'mqttObserver',\
                                'resourceClass': 'mqttObserver'})
     
    wind_speed = weather.create({'resourceName': 'wind_speed',\
                                  'resourceClass': 'ObservableProperty'})
        
    wind_speed.Observers.create({'resourceName': 'mqttObserver',\
                                'resourceClass': 'mqttObserver'})
     
    wind_direction = weather.create({'resourceName': 'wind_direction',\
                                    'resourceClass': 'ObservableProperty'})
    
    wind_direction.Observers.create({'resourceName': 'mqttObserver',\
                                    'resourceClass': 'mqttObserver'})
     
    current_rain = weather.create({'resourceName': 'current_rain',\
                                    'resourceClass': 'ObservableProperty'})
    
    current_rain.Observers.create({'resourceName': 'mqttObserver',\
                                    'resourceClass': 'mqttObserver'})
     
    hourly_rain = weather.create({'resourceName': 'hourly_rain',\
                                  'resourceClass': 'ObservableProperty'})
    
    hourly_rain.Observers.create({'resourceName': 'mqttObserver',\
                                  'resourceClass': 'mqttObserver'})
     
    daily_rain = weather.create({'resourceName': 'daily_rain',\
                                 'resourceClass': 'ObservableProperty'})
 
    daily_rain.Observers.create({'resourceName': 'mqttObserver',\
                                'resourceClass': 'mqttObserver'})
